...
In total, Floods seems to be, by far the most costly meteo events in America over those 10 years. It should be noted the special traitement of flood event cost estimates as described in the the "Storm data preparation" document. The flood does not have the "no information available" and a number should _always_ be provided.